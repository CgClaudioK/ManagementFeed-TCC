                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <table class="w-full">
                        ...
                        <tr class="border-b border-gray-700">
                                ...
                                <th class="font-bold text-left px-4 py-2">Tipo de Animal</th>
                                <th class="font-bold text-left px-4 py-2">Quantidade Total (Kg)</th>
                        ...
                        <tbody>
                            @forelse ($formulacoes as $formulacao)
                                <tr class="border-b border-gray-600">
                                    <td class="font-normal px-4 py-2">{{ $formulacao->id }}</td>
                                    <td class="font-normal px-4 py-2">{{ $formulacao->nome }}</td>
                                    <td class="font-normal px-4 py-2">{{ $formulacao->tipo_animal }}</td>
                                    <td class="font-normal px-4 py-2">{{ number_format($formulacao->quantidade_total_kg) }} Kg</td>
                                    <td class="font-normal px-4 py-2">{{ $formulacao->created_at->format('d/m/Y H:i') }}</td>
